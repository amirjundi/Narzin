...
import 'package:narzin/presentation_layer/main_app_user/profile_screens/settings_screens/password_change_screens/password_change_screen.dart';
                                    ...
                                    ontap: context.read<ProfileCubit>().isLoading
                                        ...
                                        : () async {
                                            if (_key.currentState!.validate()) {
                                              var res = await context.read<ProfileCubit>().updateProfile(choice: 1, token: BlocProvider.of<LoginCubit>(context).loginModel?.data?.token ?? '');
                                              if (res == null) {
                                  ...
                                  builder: (LocaleContext, state) {
                                    return RadioListTile<String>(
                                      ...
                                      onChanged: (value) {
                                        ...
                                        LocaleContext.read<LocalizationCubit>().setLang('en');
                                      },
                                    );
                                  },
                                ),
                                  ...
                                  child: CustomSignIn_UpOne(
                                    ...
                                    customizeChild: Row(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          S.of(context).delete_account_button,
                                          style: TextStyle(
                                            fontSize: 16,
