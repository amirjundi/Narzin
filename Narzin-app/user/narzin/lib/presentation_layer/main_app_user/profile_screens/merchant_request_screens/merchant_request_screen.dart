...
import 'package:narzin/presentation_layer/main_app_user/profile_screens/merchant_request_screens/merchant_success_screen.dart';
...
class MerchantRequestScreen extends StatelessWidget {
                ...
                child: Form(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      HeaderBuilder(
                        pageTitle: S.of(context).merchant_account_request,
                      ),
                      const SizedBox(
                        height: 20,
                      ),
                      ...
                      Text(S.of(context).store_image,style: const TextStyle(fontSize: 16),),
                      ...
                      Text(S.of(context).store_id,style: const TextStyle(fontSize: 16),),
                      const SizedBox(height: 5,),
                      InkWell(
                        onTap: () async {
            ...
            builder: (context, state) {
              ...
              return Padding(
                ...
                child: CustomSignIn_UpOne(
                  ...
                  customizeChild: isLoading? const Center(child: CircularProgressIndicator(color: Colors.white,),): Text(
                    S.of(context).send,
                  ...
                  ontap: isLoading?null: () async {
                    if (_key.currentState!.validate()) {
                      var res = await context.read<MerchantAuthCubit>().registerMerchant(token: BlocProvider.of<LoginCubit>(context).loginModel?.data?.token??'');
                      if(res == null){
                        Navigator.push(context, MaterialPageRoute(builder: (context) => const MerchantSuccessScreen(),));
                      }
                    }
                  },
                ),
