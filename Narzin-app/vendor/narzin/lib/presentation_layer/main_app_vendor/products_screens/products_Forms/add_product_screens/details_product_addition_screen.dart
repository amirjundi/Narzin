...
import 'package:narzin/presentation_layer/main_app_vendor/products_screens/products_Forms/add_product_screens/image_variant_addition_screen.dart';
...
class DetailsProductAdditionScreen extends StatelessWidget {
  DetailsProductAdditionScreen({super.key});
                ...
                children: [
                      ...
                      return Column(
                        children: [
                          ...
                          CustomTextFormField(
                            ...
                            hint: S.of(context).tax,
                            controller: context.read<ProductManipulationCubit>().tax,
                            isEnabled: true,
                            onChanged: (value) {},
                            inputFormatters: [FilteringTextInputFormatter.digitsOnly],
                            keyboardType: TextInputType.number,
                  ...
                  BlocBuilder<ProductManipulationCubit, ProductManipulationState>(
                    builder: (context, state) {
                      return InkWell(
                        onTap: () {
                          context.read<ProductManipulationCubit>().isExpiryDateSelected = false;
                          context.read<ProductManipulationCubit>().isExpiryDaysSelected = false;
                  ...
                  // CustomTextFormField(
                  //   controller: null,
                  //   title: S.of(context).discount_optional,
                  //   hint: 'xxxx',
                  //   validator: (p0) {},
                  // ),
                  // const SizedBox(
                  ...
                  // CustomTextFormField(
                  //   controller: null,
                  //   title: S.of(context).discount_code,
                  //   hint: 'xvfsd',
                  //   validator: (p0) {},
                  // ),
                  // const SizedBox(
                  ...
                  // BlocBuilder<ProductManipulationCubit, ProductManipulationState>(
                  //   builder: (context, state) {
                  //     DateTime? selectedDate = context.read<ProductManipulationCubit>().pickedDate;
                  //     return InkWell(
                  //       onTap: () {
                  //         context.read<ProductManipulationCubit>().selectDate(context);
                  //       },
                  //       child: CustomInputDecorator(
                  //         title: S.of(context).discount_expiry_date,
                  //         hint: 'DD/MM/YYYY',
                  //         suffix: const Icon(Icons.calendar_month_sharp),
                  //         child: Padding(
                  //           padding: const EdgeInsets.symmetric(horizontal: 5.0),
              ...
              ontap: isLoading
                  ...
                  : () async {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const ImageVariantAdditionScreen(),
                        ),
                      );
                    },
            );
