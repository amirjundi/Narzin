        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: [
                Text(S.of(context).congratulations,style: TextStyle(color: Color(0xff4B5563),fontSize: 16,fontWeight: FontWeight.normal),textAlign: TextAlign.justify,),
                Text(S.of(context).request_successfully_sent,style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),),
              ],
            ),
            SizedBox(height: 10,),
            Text(S.of(context).thank_you_message,style: TextStyle(color: Color(0xff4B5563),fontSize: 16,fontWeight: FontWeight.normal),textAlign: TextAlign.center,),
          ],
        ),
      ),
