...
class Devices {
  ...
  Devices.fromJson(Map<String, dynamic> json) {
    currentDevice = json['current_device'] != null
        ? new CurrentDevice.fromJson(json['current_device'])
        : null;
    if (json['all_devices'] != null) {
      allDevices = <AllDevices>[];
      json['all_devices'].forEach((v) {
        allDevices!.add(new AllDevices.fromJson(v));
      });
    }
...
class AllDevices {
  ...
  AllDevices.fromJson(Map<String, dynamic> json) {
    ...
    deviceInfo = json['device_info'] != null
        ? new CurrentDevice.fromJson(json['device_info'])
        : null;
